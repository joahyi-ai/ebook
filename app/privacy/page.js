        ...
        <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
              ...
              <ol className="list-decimal list-inside">
                <li>
                  ...
                  <ol className="list-decimal list-inside ml-5">
                    <li className="mt-2">
                      Account Registration. When you register for an Account, we
                      may ask for your contact information, including items such
                      as name, company name, address, email address, and
                      telephone number. If you choose to refer a friend to our
                      Services, we may also collect your friend&apos;s email
                      address so that we may send them a referral or promotional
                      code to sign up for our Services.
                    </li>
                    <li className="mt-2">
                      Payment Information. When you add your financial account
                      information to your Account, that information is directed
                      to our third-party payment processor. We do not store your
                      financial account information on our systems; however, we
                      have access to, and may retain, subscriber information
                      through our third-party payment processor.
                    </li>
                    <li className="mt-2">
                      User Content. Our &quot;Community&quot; feature allows you
                      to publicly post content on our Services. By registering
                      for our Community, you agree that your profile information
                      and the content you post may be viewed and used by other
                    ...
                    <li className="mt-2">
                      ...
                      may choose to provide. We may also receive a confirmation
                ...
                <li className="mt-2">
                  ...
                  <ol className="list-decimal list-inside ml-5 mt-2">
                    <li className="mt-2">
                      Cookies and Other Tracking Technologies. As is true of
                      most websites, we gather certain information automatically
                      and store it in log files. In addition, when you use our
                      Services, we may collect certain information automatically
                      from your device. This information may include internet
                      protocol (IP) addresses, browser type, internet service
                      provider (ISP), referring/exit pages, operating system,
                      date/time stamp, clickstream data, landing page, and
                      referring URL. To collect this information, a cookie may
                      be set on your computer or device when you visit our
                      Services. Cookies contain a small amount of information
                      that allows our web servers to recognize you. We store
                      information that we collect through cookies, log files,
                      and/or clear gifs to record your preferences. We may also
                      automatically collect information about your use of
                      ...
                      track your use across different websites and services. In
                      some countries, including countries in the European
                      Economic Area (&quot;EEA&quot;), the information
                      referenced above in this paragraph may be considered
                      personal information under applicable data protection
                      laws.
                    </li>
                    <li className="mt-2">
                      Usage of our Services. When you use our Services, we may
                      collect information about your engagement with and
                      utilization of our Services, such as processor and memory
                      usage, storage capacity, navigation of our Services, and
                      system-level metrics. We use this data to operate the
                      Services, maintain and improve the performance and
                      utilization of the Services, develop new features, protect
                      the security and safety of our Services and our customers,
                      and provide customer support. We also use this data to
                      develop aggregate analysis and business intelligence that
                      enable us to operate, protect, make informed decisions,
                ...
                <li className="mt-2">
                  ...
                  <ol className="list-decimal list-inside ml-5 mt-2">
                    <li className="mt-2">
                      Third-Party Accounts. If you choose to link our Services
                      to a third-party account, we will receive information
                      about that account, such as your authentication token from
                      the third-party account, to authorize linking. If you wish
                      to limit the information available to us, you should visit
                      the
                    </li>
                    <li className="mt-2">
                      privacy settings of your third-party accounts to learn
                      about your options. Third-Party Partners. We may also
                      receive publicly available information about you from our
                      third-party partners and combine it with data that we have
                      about you.
                    </li>
                  </ol>
                </li>
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <ul className="mt-6 list-decimal list-inside">
              <li>
                ...
                providers that provide services on our behalf, such as helping
                to provide our Services, for promotional and/or marketing
                purposes, and to provide you with information relevant to you
                such as product announcements, software updates, special offers,
                or other information.
              </li>
              <li>
                <span className="underline">Aggregate Information.</span>
                Where legally permissible, we may use and share information
                about users with our partners in aggregated or de-identified
              ...
              <li>
                <span className="underline"> Professional advisors.</span>
                ...
                render to us. Information We Share When You Sign Up Through a
                Referral. If you sign up for our Services through a referral
                from a friend, we may share information with your referrer to
                let them know that you used their referral to sign up for our
                Services.
              </li>
              <li>
                <span className="underline">Analytics. </span>
                We use analytics providers such as Google Analytics, Mixpanel.
                Google Analytics and Mixpanel uses cookies to collect
                non-identifying information. Google provides some additional
                privacy options regarding its Analytics cookies at
                http://www.google.com/policies/privacy/partners/ . Mixpanel
                provides some additional privacy options regarding at
                https://mixpanel.com/legal/privacy-overview/.
              </li>
              <li>
                <span className="underline">Business Transfers. </span>
                Information may be disclosed and otherwise transferred to any
                potential acquirer, successor, or assignee as part of any
                proposed merger, acquisition, debt financing, sale of assets, or
                similar transaction, or in the event of insolvency, bankruptcy,
                or receivership in which information is transferred to one or
              ...
              <li>
                <span className="underline">With Your Consent.</span>
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              only (i) where we need the personal information to perform a
              contract with you; (ii) where the processing is in our legitimate
              interests and not overridden by your rights; or (iii) where we
              have your consent to do so. We have a legitimate interest in
              operating our Services and communicating with you as necessary to
              provide these Services, for example when responding to your
              queries, improving our platform, undertaking marketing, or for the
              purposes of detecting or preventing illegal activities.
            </p>
            <p className="mt-6">
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              However, please bear in mind that the Internet cannot be
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              information. The information you provide us may be archived or
              stored periodically by us according to backup processes conducted
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              the end of the email. Even if you unsubscribe, we may still
              contact you for informational, transactional, account-related, or
              similar purposes.
            </p>
            <p className="mt-6">
              Many browsers have an option for disabling cookies, which may
              prevent your browser from accepting new cookies or enable
              ...
              advertising material but it will not be tailored to your
              interests.
            </p>
          </div>
          <div className="mt-10 max-w-2xl">
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              review it frequently. Changes to this Privacy Policy will be
              posted on our websites. If we materially change the ways in which
              we use or share personal information previously collected from you
              through our Services, we will notify you through our Services, by
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <p className="mt-6">
              ...
              initially provided the information. When we transfer your personal
